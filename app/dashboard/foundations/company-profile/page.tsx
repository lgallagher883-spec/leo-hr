...
export default function CompanyProfilePage() {
  ...
  const [leoMessage, setLeoMessage] = useState(
    "I've reviewed what I currently know about your organisation. Is everything below still accurate, or has anything changed?"
  );
  ...
  async function loadCompanyProfile() {
    ...
    if (error) {
      ...
      setErrorMessage(
        "I couldn't load your Company Profile just now. Please refresh the page and try again."
      );
  ...
  existingFacts: facts.map((fact) => ({
    ...
    value: fact.value,
      ...
      setLeoMessage(
        data.reply ||
          "Thank you. I've updated my understanding of your organisation."
      );
      ...
      setErrorMessage(
        "I couldn't update your Company Profile just now. Please try again."
      );

      setLeoMessage(
        "I'm sorry, I couldn't save that update just now."
      );
    } finally {
      setSending(false);
    }
      ...
      <div style={headerStyle}>
        <div>
          ...
          <p style={subtitleStyle}>
            Review and update Leo's understanding of your organisation.
          </p>
        </div>
      ...
      <div style={conversationCardStyle}>
        ...
        <div style={factsSectionStyle}>
          ...
          {loadingFacts ? (
            <div style={emptyStateStyle}>
              I'm retrieving your Company Profile...
            </div>
          ) : facts.length === 0 ? (
            <div style={emptyStateStyle}>
              I don't yet have any Company Profile information recorded.
              Tell me about your organisation below and I'll begin building it.
            </div>
          ) : (
        ...
        <div style={conversationPromptStyle}>
          ...
          <p style={promptTextStyle}>
            Tell Leo naturally. For example: “We now employ 32 people and have
            opened a second office in Nottingham.”
          </p>

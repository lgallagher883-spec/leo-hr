  ...
  async function loadPageData() {
    ...
    try {
      const [response, intelligenceResponse] = await Promise.all([
        fetch("/api/leo-learn/learning", {
          method: "GET",
          headers: {
            "Content-Type": "application/json",
          },
        }),
        fetch("/api/leo-learn/intelligence?section=learning", {
          method: "GET",
          headers: {
            "Content-Type": "application/json",
          },
      ...
      if (
        ...
        setLearningIntelligence(intelligencePayload.intelligence);
      }
    } catch (error) {
    ...
    return (
      <div>
        ...
        {learningIntelligence && (
          <LearningIntelligencePanel intelligence={learningIntelligence} />
        )}
...
function LearningIntelligencePanel({
  intelligence,
}: {
  intelligence: LearnIntelligence;
}) {
  return (
    <div style={intelligencePanelStyle}>
      <h3 style={intelligenceTitleStyle}>Leo Learning Intelligence</h3>
      ...
      <div style={intelligenceGridStyle}>
        <div>
          <div style={intelligenceLabelStyle}>Contextual recommendations</div>
        ...
        <div>
          <div style={intelligenceLabelStyle}>Compliance guidance</div>
          <ul style={intelligenceListStyle}>

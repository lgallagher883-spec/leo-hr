...
export function MatterProvider({
  ...
  async function addMatter(
    ...
    const newMatter: Matter = {
      ...
      matter_type:
        data.matter_type ?? null,
      subject:
        data.subject ?? null,
      matter_lead:
        data.matter_lead ?? null,
      created_at:
...
export function useMatters() {
  ...
  if (!context) {
    throw new Error(
      "useMatters must be used inside MatterProvider"
    );
  }

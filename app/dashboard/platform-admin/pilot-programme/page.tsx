    ...
    >
      ...
      >
        ...
        >
          ...
          <Link
            href="/dashboard/platform-admin/pilot-programme/invite"
            style={{
              minHeight: "44px",
              display: "inline-flex",
              alignItems: "center",
      ...
      >
        ...
        >
          ...
          >
            ...
            <Link
              href="/dashboard/platform-admin/pilot-programme/active"
              style={{
                display: "inline-flex",
                alignItems: "center",
                gap: "6px",
            ...
            >
              {[
                ...
                },
                {
                  ...
                  href: "/dashboard/platform-admin/pilot-programme/invitations",
                  icon: Link2,
                },
                {
                  label: "Export programme data",
                  href: "/dashboard/platform-admin/pilot-programme/export",
                  icon: Download,
                },
                {
                  label: "Programme settings",
                  href: "/dashboard/platform-admin/pilot-programme/settings",
                  icon: Settings2,
                },
              ].map((action) => {

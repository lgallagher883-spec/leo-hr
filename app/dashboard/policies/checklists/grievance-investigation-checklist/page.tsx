...
const resourceTitle = "Grievance Investigation Checklist";
const resourceId = "grievance-investigation-checklist";
const resourceSummary =
  "A thorough checklist for planning, conducting and documenting a fair and impartial grievance investigation.";
...
export default function GrievanceInvestigationChecklistPage() {
  ...
  function downloadWord() {
    ...
    anchor.href = url;
    anchor.download = "LEO-Grievance-Investigation-Checklist.doc";
        ...
        <div className="content-layout">
          <article className="document checklist-document" id="resource-content">
            <section>
              ...
              <p>
                Use this checklist to plan, conduct and record a fair grievance
                investigation. The investigator should establish the facts
                impartially, protect confidentiality as far as reasonably
                possible and avoid reaching conclusions before all relevant
            ...
            {[
              {
                ...
                items: [
                  "Acknowledge the grievance without unreasonable delay",
                  "Record each concern clearly and neutrally",
                  "Identify whether informal resolution may be appropriate",
                  "Confirm whether a formal investigation is required",
                  "Check for conflicts of interest before appointing the investigator",
                  "Define the investigator's terms of reference",
                  "Identify whether discrimination, harassment, whistleblowing, safeguarding or criminal concerns may be relevant",
                  "Consider whether any immediate protective measures are required",
                  "Check whether specialist or external support is needed",
                  "Confirm how confidentiality will be managed",
                ],
              },
              {
                title: "Investigation plan",
                items: [
                  "List the issues and questions to be investigated",
                  "Identify relevant documents, messages, records and policies",
                  "Identify potential witnesses",
                  "Plan the order of interviews",
                  "Set realistic timescales",
                  "Identify any data protection or confidentiality restrictions",
                  "Preserve relevant electronic records and audit evidence",
                  "Record any limitations on the investigation",
                  "Consider whether parallel disciplinary or safeguarding processes may be required",
                ],
              },
              {
                title: "Meeting with the employee raising the grievance",
                items: [
                  "Invite the employee with reasonable notice",
                  "Explain the purpose and scope of the meeting",
                  "Confirm any applicable right to be accompanied",
                  "Allow the employee to explain each concern fully",
                  "Ask what outcome or resolution they are seeking",
                  "Request relevant documents, dates, witnesses and examples",
                  "Ask open and neutral questions",
                  "Consider health, disability, language or adjustment needs",
                  "Clarify any inconsistencies or missing information",
                  "Record the meeting accurately",
                  "Give the employee an opportunity to review and confirm the record",
                ],
              },
              {
                title: "Gathering evidence",
                items: [
                  "Collect relevant policies, emails, messages, records and system evidence",
                  "Secure original evidence and preserve an audit trail",
                  "Consider evidence that supports and challenges the grievance",
                  ...
                  "Avoid accessing sensitive or personal data without a lawful and proportionate reason",
                ],
              },
              {
                title: "Witness interviews",
                items: [
                  "Invite witnesses with reasonable notice",
                  "Explain the purpose of the meeting",
                  "Explain confidentiality expectations without promising absolute secrecy",
                  ...
                  "Allow the witness to review and confirm the record",
                  "Identify inconsistencies requiring further enquiry",
                ],
              },
              {
                title: "Meeting with any person complained about",
                items: [
                  "Explain the concerns clearly and neutrally",
                  "Provide enough information for a meaningful response",
                  "Confirm that no conclusions have been reached",
                  "Allow the individual to respond fully",
                  "Ask for supporting evidence and relevant witnesses",
                  "Consider health, disability, language or adjustment needs",
                  "Record the meeting accurately",
                  "Avoid treating the meeting as a disciplinary hearing",
                  "Explain that a separate process may follow if misconduct is identified",
                ],
              },
              {
              ...
              },
              {
                ...
                items: [
                  "Address each grievance point separately",
                  "State whether each point is upheld, partially upheld or not upheld",
                  "Explain the evidence supporting each finding",
                  "Identify any unresolved factual conflicts",
                  "Record any policy, management or workplace issues identified",
                  "Avoid recommending disciplinary sanctions unless within the investigator's remit",
                  "Identify any practical resolution or remedial action",
              ...
              },
              {
                ...
                items: [
                  ...
                  "Prepare a clear written grievance outcome",
                  "Explain the reasons for each decision",
                  "Confirm any action the organisation will take",
                  "Protect confidential information about other employees",
                  "Offer a genuine right of appeal",
                  "Confirm the appeal deadline and recipient",
                  "Update the matter and audit trail",
                  "Securely retain the investigation record",
                  "Identify any separate disciplinary, policy, training or safeguarding action",
                ],
              },
            ].map((group) => (
            ...
            <section>
              ...
              <div className="details-grid">
                <div><strong>Grievance outcome</strong><span /></div>
            ...
            <div className="notice">
              ...
              grievance procedure and the ACAS Code of Practice. Grievances
              should be handled promptly, impartially and without victimisation
              or retaliation.
            </div>
          </article>
            ...
            <section className="side-card">
              ...
              <div className="related-list">
                <Link
                  ...
                  href="/dashboard/policies/factsheets/grievance-procedure"
                >
                ...
                <Link
                  className="related-link"
                  href="/dashboard/policies/letters/invitation-to-grievance-meeting"
                >
                ...
                <Link
                  className="related-link"
                  href="/dashboard/policies/letters/grievance-outcome"
                >

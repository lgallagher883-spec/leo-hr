...
export default function FlexibleWorkingPage() {
  ...
  function downloadWord() {
    ...
    anchor.href = url;
    anchor.download = "LEO-Flexible-Working.doc";
...
<h2>What is flexible working?</h2>
<p>Flexible working allows employees to request changes to their working pattern, hours, times or place of work. Requests should be considered objectively, balancing the needs of the employee with the operational needs of the organisation.</p>

<div className="notice"><strong>LEO Professional Recommendation</strong>
<p>Approach every request with an open mind. Meet with the employee, explore practical alternatives where necessary and document the reasons for your decision. Consistency and meaningful consultation reduce the risk of disputes.</p></div>

<h2>Employer responsibilities</h2>
<ul>
<li>Acknowledge requests promptly.</li>
<li>Consider each request on its own merits.</li>
<li>Meet with the employee where discussion would assist.</li>
<li>Assess operational impact using evidence rather than assumptions.</li>
<li>Provide a written outcome within the statutory timescale.</li>
<li>Offer an appeal where appropriate.</li>
</ul>

<h2>Considering the request</h2>
<p>Employers should consider service delivery, customer demand, staffing levels, cost, health and safety, performance and the availability of alternative arrangements. A request should never be rejected simply because it differs from existing working practices.</p>

<h2>Possible outcomes</h2>
<ul>
<li>Approve the request in full.</li>
<li>Agree a trial period.</li>
<li>Offer an alternative arrangement.</li>
<li>Decline the request for a lawful business reason, explaining why.</li>
</ul>

<h2>Common legal risks</h2>
<ul>
<li>Rejecting requests without genuine consideration.</li>
<li>Applying inconsistent decision making.</li>
<li>Failing to consider discrimination or reasonable adjustment issues.</li>
<li>Missing statutory response deadlines.</li>
<li>Providing inadequate reasons for refusal.</li>
</ul>

<h2>Key points for employers</h2>
<ul>
<li>Treat every request fairly and consistently.</li>
<li>Consult before making a decision.</li>
<li>Keep written records of discussions and decisions.</li>
<li>Consider alternatives where a request cannot be accommodated exactly.</li>
...
<Link className="related-link" href="/dashboard/policies/guides">Flexible Working Guide</Link>
<Link className="related-link" href="/dashboard/policies/checklists">Flexible Working Checklist</Link>
<Link className="related-link" href="/dashboard/policies/forms">Flexible Working Request Form</Link>

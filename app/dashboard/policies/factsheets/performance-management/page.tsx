...
export default function PerformanceManagementPage() {
  ...
  function downloadWord() {
    ...
    anchor.href = url;
    anchor.download = "LEO-Performance-Management.doc";
...
<p>Performance management is the ongoing process of setting expectations, providing feedback, recognising good performance and addressing concerns at an early stage. A structured approach helps employees succeed and reduces the need for formal capability action.</p>

<div className="notice"><strong>LEO Professional Recommendation</strong>
<p>Address performance concerns as soon as they arise. Set clear objectives, provide appropriate training and support, hold regular review meetings and keep written records. Formal capability procedures should normally be a last resort after reasonable support has been provided.</p></div>

<h2>Employer responsibilities</h2>
<ul>
<li>Set clear standards and measurable objectives.</li>
<li>Provide training, supervision and feedback.</li>
<li>Hold regular one-to-one meetings.</li>
<li>Identify barriers affecting performance.</li>
<li>Keep accurate records of discussions and agreed actions.</li>
</ul>

<h2>Managing underperformance</h2>
<p>Where performance falls below the required standard, explain the concerns clearly, give the employee an opportunity to respond and agree a realistic improvement plan with review dates. Consider whether health, disability, workload, training or personal circumstances are contributing factors before taking formal action.</p>

<h2>Performance Improvement Plans</h2>
<p>A Performance Improvement Plan (PIP) should identify the required standard, support available, review dates and the consequences if sufficient improvement is not achieved. Progress should be reviewed regularly and objectively.</p>

<h2>Common legal risks</h2>
<ul>
<li>Ignoring poor performance until it becomes serious.</li>
<li>Setting unclear or unrealistic objectives.</li>
<li>Failing to provide training or support.</li>
<li>Overlooking disability or reasonable adjustment duties.</li>
<li>Moving to formal action too quickly.</li>
<li>Keeping inadequate records.</li>
</ul>

<h2>Key points for employers</h2>
<ul>
<li>Manage performance continuously, not just annually.</li>
<li>Give clear feedback and achievable objectives.</li>
<li>Support improvement before considering capability action.</li>
...
<Link className="related-link" href="/dashboard/policies/guides">Performance Management Guide</Link>
<Link className="related-link" href="/dashboard/policies/checklists">Performance Review Checklist</Link>
<Link className="related-link" href="/dashboard/policies/forms">Performance Improvement Plan</Link>

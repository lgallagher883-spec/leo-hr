...
<h2>Managing sickness absence</h2>
<p>Sickness absence should be managed consistently, fairly and with appropriate support. A clear absence process helps employers maintain attendance while supporting employee wellbeing and reducing legal risk.</p>

<div className="notice"><strong>LEO Professional Recommendation</strong>
<p>Use a clear absence reporting procedure, hold return-to-work meetings after every period of absence, monitor attendance trends and intervene early where patterns emerge. Long-term absence should focus on medical evidence, reasonable adjustments and meaningful consultation.</p></div>

<h2>Employer responsibilities</h2>
<ul>
<li>Operate a clear sickness reporting procedure.</li>
<li>Maintain appropriate contact during absence.</li>
<li>Keep accurate absence records.</li>
<li>Consider occupational health or medical advice where appropriate.</li>
<li>Consider reasonable adjustments before capability action.</li>
</ul>

<h2>Short and long-term absence</h2>
<p>Short-term absence is usually managed through attendance monitoring, return-to-work meetings and supportive discussions. Long-term absence requires regular consultation, up-to-date medical information and careful consideration of alternatives before any dismissal.</p>

<h2>Return-to-work meetings</h2>
<p>Return-to-work meetings should confirm fitness to return, identify any support required, review absence patterns and update any workplace adjustments.</p>

<h2>Common mistakes</h2>
<ul>
<li>Failing to keep in contact with absent employees.</li>
<li>Ignoring recurring absence patterns.</li>
<li>Dismissing without current medical evidence.</li>
<li>Overlooking disability and reasonable adjustment duties.</li>
<li>Keeping inadequate records.</li>
</ul>

<h2>Key points for employers</h2>
<ul>
<li>Apply your absence procedure consistently.</li>
<li>Support employees while maintaining business needs.</li>
<li>Use medical evidence where appropriate.</li>
...
<Link className="related-link" href="/dashboard/policies/guides">Managing Sickness Absence Guide</Link>
<Link className="related-link" href="/dashboard/policies/checklists">Return to Work Checklist</Link>

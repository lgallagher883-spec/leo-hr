...
<p><strong>Outcome of your flexible working request</strong></p>

<p>Thank you for meeting with us on <strong>[date]</strong> to discuss your flexible working request dated <strong>[request date]</strong>.</p>

<p>Having carefully considered your request, the organisation has decided to:</p>

<ul>
<li>[Approve the request in full]</li>
<li>[Approve the request with agreed modifications]</li>
...
<ul>
<li>[Business reasons and supporting explanation.]</li>
<li>[Alternative arrangements discussed, if applicable.]</li>
</ul>

<p>If your request has been approved, the agreed working arrangements will commence on <strong>[date]</strong>. Any permanent contractual changes will be confirmed separately where required.</p>

<p>If your request has not been approved, this decision was reached after balancing your request against the operational needs of the organisation. Alternative options discussed were: [details].</p>

<p>If your organisation's procedure provides a right of review or appeal, you may submit this in writing to <strong>[name]</strong> within <strong>[5 working days]</strong>.</p>

<p>Thank you for discussing your request openly. We remain committed to considering flexible working fairly and consistently.</p>

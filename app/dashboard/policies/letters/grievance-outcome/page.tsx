...
const resourceTitle = "Grievance Outcome";
const resourceId = "grievance-outcome";
const resourceSummary = "A professionally drafted outcome letter confirming the decision following a formal grievance process."; 
...
export default function GrievanceOutcomePage() {
  ...
  function downloadWord() {
    ...
    anchor.href = url;
    anchor.download = "LEO-Grievance-Outcome.doc";
...
<p><strong>Outcome of your grievance</strong></p>

<p>Thank you for attending the grievance meeting on <strong>[date]</strong>. Having carefully considered your grievance, the information provided, the investigation findings and all available evidence, I am now able to confirm the outcome.</p>

<p><strong>Decision</strong></p>
<ul>
<li>[Summarise each grievance point.]</li>
<li>[State whether each point is upheld, partially upheld or not upheld.]</li>
<li>[Explain the reasons for the decision.]</li>
</ul>

<p><strong>Action to be taken</strong></p>
<ul>
<li>[Management action.]</li>
<li>[Training, mediation or workplace changes.]</li>
<li>[Any further investigation or review.]</li>
</ul>

<p>Where appropriate, these actions will be implemented as soon as reasonably practicable. Some outcomes may remain confidential where they relate to another employee's personal information.</p>

<p><strong>Right of appeal</strong></p>

<p>If you are dissatisfied with this outcome, you may appeal in writing to <strong>[name]</strong> within <strong>[5 working days]</strong>, setting out the grounds of your appeal.</p>

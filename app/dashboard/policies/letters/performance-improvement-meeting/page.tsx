...
const resourceTitle = "Performance Improvement Meeting Invitation";
const resourceId = "performance-improvement-meeting";
...
export default function PerformanceImprovementMeetingPage() {
  ...
  function downloadWord() {
    ...
    anchor.href = url;
    anchor.download = "LEO-Performance-Improvement-Meeting.doc";
...
<p><strong>Invitation to performance improvement meeting</strong></p>

<p>I am writing to invite you to a formal performance improvement meeting on <strong>[date]</strong> at <strong>[time]</strong> at <strong>[location / video meeting]</strong>.</p>

<p>The purpose of the meeting is to discuss concerns regarding your recent performance, review the standards expected in your role, understand any factors affecting your performance and agree appropriate support and improvement objectives.</p>

<p>The meeting may cover:</p>
<ul>
<li>Your current performance against agreed objectives.</li>
<li>Examples of the concerns identified.</li>
<li>Training, supervision or coaching requirements.</li>
<li>Workload, health or workplace factors affecting performance.</li>
<li>A Performance Improvement Plan (PIP), where appropriate.</li>
</ul>

<p>This meeting is intended to support improvement. No decision has been made regarding any formal capability outcome.</p>

<p>If your organisation's procedure provides a right to be accompanied, you may bring a workplace colleague or accredited trade union representative.</p>

<p>If you require any reasonable adjustments to attend the meeting, please let [name] know as soon as possible.</p>

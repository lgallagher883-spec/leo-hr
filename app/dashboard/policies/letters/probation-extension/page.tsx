...
const resourceTitle = "Probation Extension";
const resourceId = "probation-extension";
const resourceSummary =
  "A professionally drafted letter confirming a justified extension to an employee's probation period, including expectations, support and review arrangements."; 
...
export default function ProbationExtensionPage() {
  ...
  function downloadWord() {
    ...
    anchor.href = url;
    anchor.download = "LEO-Probation-Extension.doc";
      ...
      <div className="page-shell">
        ...
        <div className="content-layout">
          <article className="document" id="resource-content">
            ...
            <p><strong>Extension of probation period</strong></p>

            <p>
              Following your probation review meeting on [date], I am writing
              to confirm that your probation period will be extended.
            </p>

            <p>
              Your original probation period was due to end on [original end
              date]. It will now continue until [new end date].
            </p>
            ...
            <ul>
              <li>[Set out the specific performance, conduct, attendance or suitability concerns.]</li>
              <li>[Explain why further time is reasonably required.]</li>
            </ul>

            <p>
              During the extension period, you are required to achieve and
              maintain the following standards:
            </p>

            <ul>
              <li>[Objective or required standard.]</li>
              <li>[Objective or required standard.]</li>
              <li>[Any attendance or conduct expectation.]</li>
            </ul>
            ...
            <ul>
              <li>[Training, supervision or coaching.]</li>
              <li>[Additional guidance or resources.]</li>
              <li>[Any reasonable adjustment or agreed workplace support.]</li>
            </ul>

            <p>
              Your progress will be reviewed on [interim review date(s)] and at
              a final probation review meeting on [final review date].
            </p>

            <p>
              At the end of the extension, the possible outcomes will be:
            </p>

            <ul>
              <li>successful completion of probation;</li>
              <li>further action where permitted and justified; or</li>
              <li>termination of employment where the required standards have not been met.</li>
            </ul>

            <p>
              Please sign and return a copy of this letter to confirm receipt.
              Signing confirms receipt only and does not prevent you from
              raising any concerns about the extension.
            </p>
            ...
            <div className="notice">
              ...
              <p>
                Use this letter only where the contract permits probation to be
                extended and there is a clear, documented reason. LEO
                recommends one proportionate extension, normally after an
                initial three-month probation period. Confirm the extension
                before the original probation expires and avoid allowing
                probation to drift beyond six months.
              </p>
            </div>
          </article>

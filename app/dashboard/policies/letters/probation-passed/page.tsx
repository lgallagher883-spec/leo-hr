...
const resourceTitle = "Probation Successfully Completed";
const resourceId = "probation-passed";
const resourceSummary =
  "A professionally drafted letter confirming successful completion of an employee's probation period."; 
...
export default function ProbationPassedPage() {
  ...
  function downloadWord() {
    ...
    anchor.href = url;
    anchor.download = "LEO-Probation-Successfully-Completed.doc";
      ...
      <div className="page-shell">
        ...
        <div className="content-layout">
          <article className="document" id="resource-content">
            ...
            <p><strong>Successful completion of probation</strong></p>

            <p>
              I am pleased to confirm that you have successfully completed your
              probation period in the role of [job title].
            </p>

            <p>
              Your probation review took place on [date] and considered your
              performance, conduct, attendance, progress against objectives and
              overall suitability for the role.
            </p>

            <p>
              We are satisfied that you have met the required standards and
              your appointment is now confirmed with effect from [effective
              date].
            </p>

            <p>
              Your employment will continue under the terms and conditions set
              out in your contract of employment. From [effective date], the
              following arrangements will apply:
            </p>

            <ul>
              <li>Notice period: [notice period].</li>
              <li>Salary or pay arrangements: [details, if changing].</li>
              <li>Benefits or entitlements: [details, if applicable].</li>
              <li>Any ongoing objectives or development actions: [details].</li>
            </ul>

            <p>
              Thank you for your contribution during your probation period. We
              look forward to supporting your continued development in the
              role.
            </p>
            ...
            <div className="notice">
              ...
              <p>
                Use this letter only after the probation outcome has been
                formally approved. Check the contract before confirming any
                change to notice, pay, benefits or status. Keep a signed copy

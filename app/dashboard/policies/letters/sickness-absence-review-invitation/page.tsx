...
<p><strong>Invitation to sickness absence review meeting</strong></p>

<p>I am writing to invite you to a formal sickness absence review meeting on <strong>[date]</strong> at <strong>[time]</strong> at <strong>[location/video]</strong>.</p>

<p>The purpose of the meeting is to discuss your recent sickness absence, understand your current health, consider any support that may assist your return to work and review any ongoing attendance concerns.</p>

<p>The meeting may include discussion about:</p>
<ul>
<li>Your attendance record.</li>
<li>Medical evidence or fit notes.</li>
<li>Occupational Health advice (where appropriate).</li>
<li>Reasonable adjustments if a disability may be relevant.</li>
<li>Possible next steps following the meeting.</li>
</ul>

<p>You have the right to be accompanied by a workplace colleague or accredited trade union representative where this forms part of the organisation's formal procedure.</p>

<p>No decisions have been made. This meeting is intended to understand the circumstances fully before any action is considered.</p>

<p>If you need any reasonable adjustments to attend the meeting, or cannot attend for a genuine reason, please contact [name] as soon as possible so that suitable arrangements can be discussed.</p>

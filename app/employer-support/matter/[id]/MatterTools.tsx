...
export default function MatterTools({matterId}:{matterId:number}){
 ...
 return <div className={styles.matterTools}>
  ...
  <button type="button" className={styles.toolButton} onClick={()=>document.querySelector<HTMLTextAreaElement>('textarea[placeholder*="Tell Leo"]')?.focus()}><span>✦</span><div><strong>Ask Leo what to do next</strong><small>Continue working through this Matter</small></div></button>

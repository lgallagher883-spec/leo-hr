      ...
      <section className="auth-card">
        ...
        {checking ? (
          <div className="state" role="status">
            ...
            <p>
              Please wait while LEO™ securely validates the
              link.
            </p>
          </div>
        ) : !validSession ? (
          ...
          <div className="state" role="status">
            ...
            <p>
              Your password has been changed securely. You are
              being returned to the sign-in page.
            </p>
          </div>
        ) : (
          <>
            <div className="heading">
              ...
              <p>
                Choose a new password for your LEO™ account.
              </p>
            </div>
            ...
            <form onSubmit={submit} noValidate>
              ...
              <p className="password-guidance">
                Use at least 8 characters. A longer, unique
        ...
        * {
        ...
        .auth-page {
          ...
          background:
            radial-gradient(
              circle at 10% 10%,
              rgba(205, 178, 226, 0.24),
              transparent 32%
            ),
            radial-gradient(
              circle at 90% 90%,
              rgba(221, 246, 236, 0.65),
              transparent 30%
            ),
            #f8f5fb;
          color: #172036;
        ...
        .auth-card {
          ...
          box-shadow: 0 24px 70px rgba(55, 37, 73, 0.11);
        }
...
function ResetPasswordLoading() {
  return (
    <main className="auth-page">
      <section className="auth-card">
        <div className="state" role="status">
          <h1>Loading secure recovery</h1>
          <p>Please wait while LEO™ prepares the page.</p>
        </div>
      </section>
